...
const baseCredentialSchema = z.object({
  ...
  description: z
    ...
    .nullable()
    .or(z.literal("")),
  apiKey: z.string().max(5000, "API key is too long").optional().nullable().or(z.literal("")),
  username: z.string().max(255, "Username is too long").optional().nullable().or(z.literal("")),
  password: z.string().max(5000, "Password is too long").optional().nullable().or(z.literal("")),
  cookieValue: z.string().max(5000, "Cookie value is too long").optional().nullable().or(z.literal("")),
  customHeaders: z.string().max(5000, "Custom headers are too long").optional().nullable().or(z.literal("")),
});
