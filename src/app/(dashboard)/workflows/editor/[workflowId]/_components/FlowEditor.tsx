  ...
  if (activeView === "runs") {
    return (
      <main className="flex min-h-0 flex-1 flex-col bg-background p-5 dark:bg-[#0b0909]">
        <div className="flex min-h-0 flex-1 flex-col rounded-none border bg-card/90 p-5 shadow-sm dark:border-zinc-800 dark:bg-[#111010]">
          ...
          <div className="grid min-h-0 flex-1 gap-4 xl:grid-cols-[minmax(0,1.25fr)_380px]">
            <div className="min-h-[320px] rounded-none border bg-background/80 p-4 dark:border-zinc-800 dark:bg-[#0b0909]">
              ...
              {executionLogs.length === 0 ? (
                <div className="flex h-full min-h-[240px] items-center justify-center rounded-none border border-dashed bg-muted/30 px-6 text-center text-sm text-muted-foreground dark:border-zinc-800 dark:bg-zinc-950/50 dark:text-zinc-500">
                  No execution logs yet. Switch to the editor view and run the workflow once to generate a run history.
                </div>
              ) : (
                <div className="space-y-3">
                  {executionLogs.map((log) => (
                    <div key={log} className="rounded-none border bg-background px-4 py-3 text-sm text-foreground dark:border-zinc-800 dark:bg-zinc-950/70 dark:text-zinc-200">
                      {log}
                    </div>
                  ))}
                </div>
            ...
            <div className="space-y-4">
              <div className="rounded-none border bg-background/80 p-4 dark:border-zinc-800 dark:bg-[#0b0909]">
              ...
              <div className="rounded-none border bg-background/80 p-4 dark:border-zinc-800 dark:bg-[#0b0909]">
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-3">
                  <div className="rounded-none border bg-background px-3 py-4 dark:border-zinc-800 dark:bg-zinc-950/70">
  ...
  return (
    ...
    >
      ...
      >
        <Panel
          position="top-left"
          className="font-canvas rounded-none border bg-background/95 px-4 py-3 shadow-lg backdrop-blur dark:border-zinc-800 dark:bg-[#111010]/95"
        >
          <div className="flex items-center gap-2">
            <div className="h-2.5 w-2.5 rounded-full bg-emerald-400 shadow-[0_0_12px_rgba(74,222,128,0.8)]" />
            <p className="text-base font-semibold text-foreground dark:text-white">Editor canvas</p>
          </div>
          <p className="mt-1 text-sm leading-6 text-muted-foreground dark:text-zinc-400">
        ...
        <Panel
          position="top-right"
          className="font-canvas flex items-center gap-2 rounded-none border bg-background/95 px-3 py-2 shadow-lg backdrop-blur dark:border-zinc-800 dark:bg-[#111010]/95"
        >
          <div className="rounded-none border border-border bg-background/80 px-2.5 py-1.5 text-sm text-muted-foreground dark:border-zinc-700 dark:bg-zinc-950/80 dark:text-zinc-400">
        ...
        {(executionError || executionLogs.length > 0) && (
          <Panel
            ...
            className="font-canvas w-[340px] rounded-none border bg-background/95 p-3 text-sm shadow-lg backdrop-blur dark:border-zinc-800 dark:bg-[#111010]/95"
          >
        ...
        <Controls
          ...
          fitViewOptions={fitViewOptions}
          className="!rounded-none !border !bg-background/95 !shadow-lg dark:!border-zinc-800 dark:!bg-[#111010]/95"
        />
        <MiniMap
          pannable
          zoomable
      ...
      {contextMenuPosition && (
        <div
          className="absolute z-50 min-w-44 rounded-none border bg-background p-1 shadow-lg dark:border-zinc-800 dark:bg-[#111010]"
