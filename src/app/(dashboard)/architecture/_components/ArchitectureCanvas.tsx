...
export default function ArchitectureCanvas({ architectureId }: { architectureId: string }) {
  ...
  return (
    ...
    >
      <div className="flex min-w-0 flex-wrap items-center justify-between gap-3 rounded-none border bg-background/92 px-4 py-3 shadow-sm backdrop-blur dark:border-slate-800/80 dark:bg-slate-950/88">
