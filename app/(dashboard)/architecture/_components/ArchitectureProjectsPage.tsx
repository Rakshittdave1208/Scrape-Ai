    ...
    <ArchitectureDeleteProvider onDeleted={refreshProjects}>
      <div className="space-y-6">
        ...
        <section className="space-y-4">
          {projects.length === 0 ? (
            <div className="rounded-2xl border border-dashed bg-card/80 px-5 py-10 text-center shadow-sm backdrop-blur">
...
function ArchitectureProjectRow({
  ...
  return (
    <div className="flex items-center justify-between gap-4 rounded-2xl border bg-card/80 p-4 shadow-sm backdrop-blur transition hover:shadow-md dark:border-slate-800/80 dark:bg-slate-950/80">
