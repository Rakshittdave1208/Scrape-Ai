...
function Editor({ workflow }: { workflow: WorkflowForEditor }) {
  ...
  return (
    <ReactFlowProvider>
      <div className="flex h-full min-h-0 w-full flex-1 flex-col overflow-hidden rounded-2xl border bg-card/90 text-foreground shadow-[0_24px_70px_rgba(15,23,42,0.10)] backdrop-blur dark:border-zinc-800 dark:bg-[#090707] dark:text-zinc-100 dark:shadow-[0_24px_70px_rgba(0,0,0,0.35)]">
            ...
            <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
              <div className="flex items-start gap-3">
                <Button
                  ...
                  variant="ghost"
                  size="icon"
                  className="mt-0.5 h-9 w-9 rounded-xl border bg-background/90 text-muted-foreground hover:bg-accent hover:text-accent-foreground dark:border-zinc-800 dark:bg-zinc-900/80 dark:text-zinc-300 dark:hover:bg-zinc-800 dark:hover:text-white"
                >
                  <Link href="/workflows">
              ...
              <div className="flex flex-col gap-4 xl:items-end">
                <div className="flex rounded-xl border border-border bg-muted/60 p-1 dark:border-zinc-800 dark:bg-zinc-950/80">
                  <button
                    type="button"
                    onClick={() => setActiveView("editor")}
                    className={`min-w-28 rounded-lg px-5 py-2 text-sm font-medium transition ${
                      activeView === "editor"
                ...
                <div className="flex flex-wrap items-center justify-end gap-2">
                  <div className="rounded-xl border border-border bg-background/90 px-3 py-2 text-xs text-muted-foreground dark:border-zinc-800 dark:bg-zinc-950/90 dark:text-zinc-400">
